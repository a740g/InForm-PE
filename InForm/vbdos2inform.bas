...
PRINT "InForm-PE GUI engine for QB64-PE - v"; __UI_Version
PRINT "VBDOS to InForm-PE form conversion utility"
PRINT "-------------------------------------------------"
...
DIM o$: o$ = "' InForm-PE for QB64-PE - v" + __UI_Version
o$ = o$ + lf + "' Copyright (c) 2025 QB64 Phoenix Edition Team"
o$ = o$ + lf + "'-----------------------------------------------------------"
