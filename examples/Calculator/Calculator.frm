...
': InForm GUI engine for QB64-PE - v1.5.8
...
SUB __UI_LoadForm
    ...
    __UI_NewID = __UI_NewControl(__UI_Type_MenuBar, "mnuEdit", 36, 21, 8, 0, 0)
    __UI_RegisterResult = 0
    SetCaption __UI_NewID, "&Edit"
    Control(__UI_NewID).HasBorder = False

    __UI_NewID = __UI_NewControl(__UI_Type_MenuBar, "mnuHelp", 41, 21, 44, 0, 0)
    __UI_RegisterResult = 0
    ...
    __UI_NewID = __UI_NewControl(__UI_Type_Label, "lblAnswer", 195, 33, 22, 17, __UI_GetID("frmResults"))
    __UI_RegisterResult = 0
