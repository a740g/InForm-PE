...
'$INCLUDE:'../InForm/extensions/Array.bi'
...
SUB Test_Queue
    ...
    Queue_Clear q()
    DIM initialCapacity AS LONG: initialCapacity = Queue_GetCapacity(q())
...
'$INCLUDE:'../InForm/extensions/Array.bm'
'$INCLUDE:'../InForm/extensions/Algo.bm'

'$INCLUDE:'../InForm/extensions/Catch.bm'
